  ...
  switch (valueTriangle) {
    ...
    case 1:
      if (millis() - timeRan_Line_1 <= 6000) {
        lineFollowing_1();
      } else if (millis() - timeRan_Line_1 >= 6000 && millis() - timeRan_Line_1 <= 8000) {
        controlDC(0, 0);
        pwm.setPWM(3, 0, SERVO_360_MIN);
        pwm.setPWM(4, 0, SERVO_360_MAX);
      } else if (millis() - timeRan_Line_1 >= 8000 && millis() - timeRan_Line_1 <= 9000) {
        pwm.setPWM(3, 0, 0);
        pwm.setPWM(4, 0, 0);
        controlBackward(1000, 1000);
      }
  ...
  switch (valueSquare) {
    ...
    case 1:
      if (millis() - timeRan_Line_2 <= 6000) {
        lineFollowing_2();
      } else if (millis() - timeRan_Line_2 >= 6000 && millis() - timeRan_Line_2 <= 8000) {
        controlDC(0, 0);
        pwm.setPWM(3, 0, SERVO_360_MIN);
        pwm.setPWM(4, 0, SERVO_360_MAX);
      } else if (millis() - timeRan_Line_2 >= 8000 && millis() - timeRan_Line_2 <= 9000) {
        pwm.setPWM(3, 0, 0);
        pwm.setPWM(4, 0, 0);
        controlBackward(1000, 1000);
      }
  ...
  switch (valueCircle) {
    ...
    case 1:
      if (millis() - timeRan_Line_3 <= 6000) {
        lineFollowing_3();
      } else if (millis() - timeRan_Line_3 >= 6000 && millis() - timeRan_Line_3 <= 8000) {
        controlDC(0, 0);
        pwm.setPWM(3, 0, SERVO_360_MIN);
        pwm.setPWM(4, 0, SERVO_360_MAX);
      } else if (millis() - timeRan_Line_3 >= 8000 && millis() - timeRan_Line_3 <= 9000) {
        pwm.setPWM(3, 0, 0);
        pwm.setPWM(4, 0, 0);
        controlBackward(1000, 1000);
      }
